...
mkdir -p ${buildroot}%{_datarootdir}/spdk/
install -p -m 644 include/spdk/pci_ids.h ${buildroot}%{_datadir}/spdk/
install -p -m 644 scripts/common.sh ${buildroot}%{_datadir}/spdk/
install -p -m 755 scripts/setup.sh ${buildroot}%{_datadir}/spdk/
install -p -m 755 contrib/arp_fixup.sh %{buildroot}/%{_sbindir}
